...
Pagy.options[:client_max_limit] = 50   # The client can request a limit up to
#                                         # 100
...
# See https://ddnexus.github.io/pagy/toolbox/paginators/calendar#localization
# for details.
# Add your desired locales to the list and uncomment the following line to
# enable them, regardless of whether you use the I18n gem for translations or
# not, whether with Rails or not.
#

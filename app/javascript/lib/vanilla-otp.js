// See: https://github.com/shuqikhor/Vanilla-OTP-Input/blob/e6aa8fc0d3416467a987419d249d773311483585/vanilla-otp.js
const VanillaOTP = function (elementOrSelector, updateToInput = null) {
  // set default options
  this.emptyChar = " ";
  ...
  const instance = this;
  const inputCount = instance.inputs.length;
...
VanillaOTP.prototype.destroy = function () {

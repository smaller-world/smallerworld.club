...
Now, instead of using the custom elements directly, you can use the React-specific components. For example, instead of using `<el-disclosure>`, use `<ElDisclosure>`:
...
A button that toggles the options dropdown when clicked.

| Type                        | Name          | Description                                                           |
| --------------------------- | ------------- | --------------------------------------------------------------------- |
| ARIA attributes (Read-only) | aria-expanded | Set to "true" when the options dropdown is open, "false" when closed. |
...
| Type     | Name   | Description                       |
| -------- | ------ | --------------------------------- |
| Commands | --copy | Copies the text to the clipboard. |
...
| Type                        | Name        | Description                                                        |
| --------------------------- | ----------- | ------------------------------------------------------------------ |
| Data attributes (Read-only) | data-copied | Present for 2 seconds after the text has been successfully copied. |
| Data attributes (Read-only) | data-error  | Present when there was an error during the copy operation.         |
...
| Type                        | Name          | Description                                                 |
| --------------------------- | ------------- | ----------------------------------------------------------- |
| ARIA attributes (Read-only) | aria-expanded | Set to "true" when the dialog is open, "false" when closed. |
...
A button that triggers the disclosure when clicked.

| Type                        | Name          | Description                                                     |
| --------------------------- | ------------- | --------------------------------------------------------------- |
| ARIA attributes (Read-only) | aria-expanded | Set to "true" when the disclosure is open, "false" when closed. |
...
A button that toggles the popover when clicked.

| Type                        | Name          | Description                                                  |
| --------------------------- | ------------- | ------------------------------------------------------------ |
| ARIA attributes (Read-only) | aria-expanded | Set to "true" when the popover is open, "false" when closed. |

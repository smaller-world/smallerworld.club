...
#
# source://http-2//lib/http/2/version.rb#3
module HTTP2; end

# source://http-2//lib/http/2/extensions.rb#4
module HTTP2::BufferUtils
  # source://http-2//lib/http/2/extensions.rb#6
  def append_str(str, data); end

  # source://http-2//lib/http/2/extensions.rb#25
  def read_str(str, n); end

  # source://http-2//lib/http/2/extensions.rb#34
  def read_uint32(str); end

  # source://http-2//lib/http/2/extensions.rb#38
  def shift_byte(str); end
end

# source://http-2//lib/http/2/connection.rb#42
HTTP2::CONNECTION_FRAME_TYPES = T.let(T.unsafe(nil), Array)

# Default connection "fast-fail" preamble string as defined by the spec.
#
# source://http-2//lib/http/2/connection.rb#36
...
class HTTP2::Client < ::HTTP2::Connection
  ...
  # @see Connection
  #
  # source://http-2//lib/http/2/client.rb#39
  def send(frame); end

  # Emit the connection preface if not yet
  #
  # source://http-2//lib/http/2/client.rb#61
  ...
  # @raise [ProtocolError]
  #
  # source://http-2//lib/http/2/client.rb#50
  def upgrade; end

  private

  # source://http-2//lib/http/2/client.rb#78
  def verify_pseudo_headers(frame); end

  class << self
    # source://http-2//lib/http/2/client.rb#71
...
#
# source://http-2//lib/http/2/connection.rb#55
class HTTP2::Connection
  ...
  #
  # source://http-2//lib/http/2/connection.rb#83
  def initialize(settings = T.unsafe(nil)); end

  # source://http-2//lib/http/2/connection.rb#424
  def <<(data); end

  # Number of active streams between client and server (reserved streams
  # are not counted towards the stream limit).
  #
  # source://http-2//lib/http/2/connection.rb#79
  ...
  # @return [Boolean]
  #
  # source://http-2//lib/http/2/connection.rb#116
  def closed?; end
  ...
  #
  # source://http-2//lib/http/2/connection.rb#158
  def goaway(error = T.unsafe(nil), payload = T.unsafe(nil)); end

  # Current settings value for local and peer
  #
  # source://http-2//lib/http/2/connection.rb#71
  ...
  #
  # source://http-2//lib/http/2/connection.rb#75
  ...
  #
  # source://http-2//lib/http/2/connection.rb#189
  def receive(data); end

  # Returns the value of attribute remote_settings.
  #
  # source://http-2//lib/http/2/connection.rb#67
  ...
  #
  # source://http-2//lib/http/2/connection.rb#177
  def settings(payload); end

  # Connection state (:new, :closed).
  #
  # source://http-2//lib/http/2/connection.rb#62
  def state; end
  ...
  #
  # source://http-2//lib/http/2/connection.rb#168
  ...
  # @return [Boolean]
  #
  # source://http-2//lib/http/2/connection.rb#471
  ...
  # @param frame [Hash]
  #
  # source://http-2//lib/http/2/connection.rb#482
  ...
  # @param frame [Hash]
  #
  # source://http-2//lib/http/2/connection.rb#458
  ...
  # @raise []
  #
  # source://http-2//lib/http/2/connection.rb#839
  ...
  # @param frame [Hash]
  #
  # source://http-2//lib/http/2/connection.rb#436
  def send(frame); end
...
#
# source://http-2//lib/http/2/emitter.rb#7
...
#
# source://http-2//lib/http/2/error.rb#5
module HTTP2::Error
  class << self
    # Returns the value of attribute types.
    #
    # source://http-2//lib/http/2/error.rb#9
    def types; end
  end
end
...
# @see ProtocolError
#
# source://http-2//lib/http/2/error.rb#38
...
# cannot be opened.
#
# source://http-2//lib/http/2/error.rb#58
class HTTP2::Error::ConnectionClosed < ::HTTP2::Error::Error; end

# source://http-2//lib/http/2/error.rb#12
class HTTP2::Error::Error < ::StandardError
  class << self
    # @private
    #
    # source://http-2//lib/http/2/error.rb#13
...
# @see ProtocolError
#
# source://http-2//lib/http/2/error.rb#43
class HTTP2::Error::FlowControlError < ::HTTP2::Error::ProtocolError; end

# source://http-2//lib/http/2/error.rb#63
...
#
# source://http-2//lib/http/2/error.rb#28
...
#
# source://http-2//lib/http/2/error.rb#47
...
#
# source://http-2//lib/http/2/error.rb#61
...
#
# source://http-2//lib/http/2/flow_buffer.rb#7
module HTTP2::FlowBuffer
  ...
  # @return [Integer]
  #
  # source://http-2//lib/http/2/flow_buffer.rb#18
  def buffered_amount; end

  # source://http-2//lib/http/2/flow_buffer.rb#22
  def flush; end

  # Returns the value of attribute send_buffer.
  #
  # source://http-2//lib/http/2/flow_buffer.rb#10
  def send_buffer; end

  private

  # source://http-2//lib/http/2/flow_buffer.rb#34
  def calculate_window_update(window_max_size); end

  # source://http-2//lib/http/2/flow_buffer.rb#104
  ...
  # source://http-2//lib/http/2/flow_buffer.rb#91
  def send_frame(frame, encode); end

  # source://http-2//lib/http/2/flow_buffer.rb#28
  def update_local_window(frame); end
end

# source://http-2//lib/http/2/flow_buffer.rb#12
HTTP2::FlowBuffer::MAX_WINDOW_SIZE = T.let(T.unsafe(nil), Integer)

# source://http-2//lib/http/2/flow_buffer.rb#117
class HTTP2::FrameBuffer
  # @return [FrameBuffer] a new instance of FrameBuffer
  #
  # source://http-2//lib/http/2/flow_buffer.rb#120
  def initialize; end

  # source://http-2//lib/http/2/flow_buffer.rb#125
  def <<(frame); end

  # Returns the value of attribute bytesize.
  #
  # source://http-2//lib/http/2/flow_buffer.rb#118
  def bytesize; end

  # @return [Boolean]
  #
  # source://http-2//lib/http/2/flow_buffer.rb#130
  def empty?; end

  # source://http-2//lib/http/2/flow_buffer.rb#134
  def retrieve(window_size); end
end

# Performs encoding, decoding, and validation of binary HTTP/2 frames.
#
# source://http-2//lib/http/2/framer.rb#6
class HTTP2::Framer
  include ::HTTP2::Error
  ...
  #
  # source://http-2//lib/http/2/framer.rb#118
  ...
  # @return [String]
  #
  # source://http-2//lib/http/2/framer.rb#130
  ...
  # @param frame [Hash]
  #
  # source://http-2//lib/http/2/framer.rb#199
  def generate(frame); end

  # maximum frame size
  #
  # source://http-2//lib/http/2/framer.rb#15
  ...
  # @raise [ProtocolError]
  #
  # source://http-2//lib/http/2/framer.rb#373
  def parse(buf); end
  ...
  #
  # source://http-2//lib/http/2/framer.rb#177
...
#
# source://http-2//lib/http/2/header.rb#8
module HTTP2::Header; end

# Responsible for encoding header key-value pairs using HPACK algorithm.
#
# source://http-2//lib/http/2/header/compressor.rb#6
class HTTP2::Header::Compressor
  ...
  #
  # source://http-2//lib/http/2/header/compressor.rb#11
  ...
  # @return [Buffer]
  #
  # source://http-2//lib/http/2/header/compressor.rb#132
  ...
  #
  # source://http-2//lib/http/2/header/compressor.rb#38
  ...
  #
  # source://http-2//lib/http/2/header/compressor.rb#17
  ...
  # @return [String] binary string
  #
  # source://http-2//lib/http/2/header/compressor.rb#166
...
#
# source://http-2//lib/http/2/header/decompressor.rb#12
class HTTP2::Header::Decompressor
  ...
  #
  # source://http-2//lib/http/2/header/decompressor.rb#19
  def initialize(options = T.unsafe(nil)); end
  ...
  #
  # source://http-2//lib/http/2/header/decompressor.rb#116
  ...
  # @return [Hash] command
  #
  # source://http-2//lib/http/2/header/decompressor.rb#78
  def header(buf); end
  ...
  # @return [Integer]
  #
  # source://http-2//lib/http/2/header/decompressor.rb#34
  ...
  #
  # source://http-2//lib/http/2/header/decompressor.rb#62
  def string(buf); end
  ...
  # @param size [Integer] new dynamic table size
  #
  # source://http-2//lib/http/2/header/decompressor.rb#25
  def table_size=(size); end
end

# source://http-2//lib/http/2/header/decompressor.rb#16
HTTP2::Header::Decompressor::FORBIDDEN_HEADERS = T.let(T.unsafe(nil), Array)

# source://http-2//lib/http/2/header/encoding_context.rb#8
class HTTP2::Header::EncodingContext
  ...
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#119
  def initialize(options = T.unsafe(nil)); end
  ...
  # @return [Hash] command
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#262
  def addcmd(field, value); end

  # Current table size in octets
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#110
  ...
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#150
  ...
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#129
  def dup; end
  ...
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#233
  def encode(headers); end

  # source://http-2//lib/http/2/header/encoding_context.rb#308
  ...
  #   :index       Symbol   :all, :static, :never
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#107
  def options; end
  ...
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#167
  def process(cmd); end

  # Current table of header key-value pairs.
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#100
  def table; end

  # Alter dynamic table size.
  #  When the size is reduced, some headers might be evicted.
  #
  # source://http-2//lib/http/2/header/encoding_context.rb#303
  def table_size=(size); end
...
# source://http-2//lib/http/2/header/encoding_context.rb#95
HTTP2::Header::EncodingContext::STATIC_ALL = T.let(T.unsafe(nil), Array)

# source://http-2//lib/http/2/header/encoding_context.rb#97
...
module HTTP2::Header::Huffman
  ...
  # @return [String] binary string
  #
  # source://http-2//lib/http/2/header/huffman.rb#41
  def decode(buf); end
...
# source://http-2//lib/http/2/header/huffman.rb#19
...
#   end
#
# source://http-2//lib/http/2/server.rb#23
class HTTP2::Server < ::HTTP2::Connection
  # Initialize new HTTP 2.0 server object.
  #
  # @return [Server] a new instance of Server
  #
  # source://http-2//lib/http/2/server.rb#27
  def initialize(settings = T.unsafe(nil)); end

  # source://http-2//lib/http/2/server.rb#123
  def activate_stream(**_arg0); end

  # Returns the value of attribute origin_set.
  #
  # source://http-2//lib/http/2/server.rb#24
  def origin_set; end

  # source://http-2//lib/http/2/server.rb#129
  ...
  #
  # source://http-2//lib/http/2/server.rb#72
  def upgrade(settings, headers, body); end

  private

  # source://http-2//lib/http/2/server.rb#136
  def connection_settings(frame); end
  ...
  # source://http-2//lib/http/2/server.rb#143
  def verify_pseudo_headers(frame); end
end
...
#                         +--------+
#
# source://http-2//lib/http/2/stream.rb#38
class HTTP2::Stream
  include ::HTTP2::Error
  include ::HTTP2::FlowBuffer
  include ::HTTP2::Emitter
  ...
  #
  # source://http-2//lib/http/2/stream.rb#287
  def cancel; end

  # Chunk data into max_size, yield each chunk, then return final chunk
  #
  # source://http-2//lib/http/2/stream.rb#268
  ...
  #
  # source://http-2//lib/http/2/stream.rb#282
  def close(error = T.unsafe(nil)); end

  # Reason why connection was closed.
  #
  # source://http-2//lib/http/2/stream.rb#63
  def closed; end

  # @return [Boolean]
  #
  # source://http-2//lib/http/2/stream.rb#107
  def closed?; end
  ...
  #
  # source://http-2//lib/http/2/stream.rb#56
  def dependency; end
  ...
  #
  # source://http-2//lib/http/2/stream.rb#46
  def id; end
  ...
  #
  # source://http-2//lib/http/2/stream.rb#52
  def parent; end

  # @raise [ArgumentError]
  #
  # source://http-2//lib/http/2/stream.rb#229
  ...
  #
  # source://http-2//lib/http/2/stream.rb#293
  def refuse; end
  ...
  # @param frame [Hash]
  #
  # source://http-2//lib/http/2/stream.rb#199
  def send(frame); end

  # Stream state as defined by HTTP 2.0.
  #
  # source://http-2//lib/http/2/stream.rb#49
  def state; end

  # source://http-2//lib/http/2/stream.rb#171
  def verify_trailers(frame); end

  # Stream priority as set by initiator.
  #
  # source://http-2//lib/http/2/stream.rb#55
  def weight; end
  ...
  # @param increment [Integer]
  #
  # source://http-2//lib/http/2/stream.rb#300
  def window_update(increment); end
  ...
  # permitted to open.
  #
  # source://http-2//lib/http/2/stream.rb#625
  def activate_stream_in_conn; end

  # source://http-2//lib/http/2/stream.rb#631
  def close_stream_in_conn(*args); end

  # source://http-2//lib/http/2/stream.rb#636
  def complete_transition(frame); end

  # @return [Boolean]
  #
  # source://http-2//lib/http/2/stream.rb#663
  ...
  # source://http-2//lib/http/2/stream.rb#681
  def manage_state(frame); end

  # source://http-2//lib/http/2/stream.rb#647
  ...
  #                         +--------+
  #
  # source://http-2//lib/http/2/stream.rb#341
  def transition(frame, sending); end
end

# source://http-2//lib/http/2/stream.rb#43
HTTP2::Stream::STREAM_OPEN_STATES = T.let(T.unsafe(nil), Array)

# source://http-2//lib/http/2/version.rb#4

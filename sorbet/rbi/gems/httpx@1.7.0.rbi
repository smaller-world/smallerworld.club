...
class HTTPX::Connection
  ...
  # source://httpx//lib/httpx/connection.rb#853
...
class HTTPX::Connection::HTTP1
  ...
  # source://httpx//lib/httpx/connection/http1.rb#232
  def waiting_for_ping?; end

  private

  # source://httpx//lib/httpx/connection/http1.rb#394
  def capitalized(field); end

  # source://httpx//lib/httpx/connection/http1.rb#274
  def disable; end

  # source://httpx//lib/httpx/connection/http1.rb#281
  def disable_pipelining; end

  # source://httpx//lib/httpx/connection/http1.rb#336
  def handle(request); end

  # source://httpx//lib/httpx/connection/http1.rb#363
  def join_body(request); end

  # source://httpx//lib/httpx/connection/http1.rb#353
  def join_headers(request); end

  # source://httpx//lib/httpx/connection/http1.rb#386
  def join_headers2(headers); end

  # source://httpx//lib/httpx/connection/http1.rb#349
  def join_headline(request); end

  # source://httpx//lib/httpx/connection/http1.rb#378
  def join_trailers(request); end

  # source://httpx//lib/httpx/connection/http1.rb#238
  def manage_connection(request, response); end

  # source://httpx//lib/httpx/connection/http1.rb#301
...
# source://httpx//lib/httpx/options.rb#457
...
#
# source://httpx//lib/httpx/options.rb#449
...
class HTTPX::Pool
  ...
  # source://httpx//lib/httpx/pool.rb#163
  ...
  # :nocov:
  #
  # source://httpx//lib/httpx/pool.rb#180
  def inspect; end
  ...
  # source://httpx//lib/httpx/pool.rb#191
  def acquire_connection(uri, options); end

  # source://httpx//lib/httpx/pool.rb#201
  def checkout_new_connection(uri, options); end

  # source://httpx//lib/httpx/pool.rb#207
  ...
  #
  # source://httpx//lib/httpx/pool.rb#219
...
module HTTPX::Resolver
  ...
  # source://httpx//lib/httpx/resolver.rb#74
  def cached_lookup(hostname); end

  # source://httpx//lib/httpx/resolver.rb#110
  def cached_lookup_evict(hostname, ip); end

  # source://httpx//lib/httpx/resolver.rb#81
  def cached_lookup_set(hostname, family, entries); end

  # source://httpx//lib/httpx/resolver.rb#169
  def decode_dns_answer(payload); end

  # source://httpx//lib/httpx/resolver.rb#162
  ...
  def lookup(hostname, lookups, hostnames, ttl); end

  # source://httpx//lib/httpx/resolver.rb#49
  def nolookup_resolve(hostname); end

  # @raise [Error]
  #
  # source://httpx//lib/httpx/resolver.rb#36
  def resolver_for(resolver_type, options); end

  # source://httpx//lib/httpx/resolver.rb#28
  def supported_ip_families; end

  private

  # source://httpx//lib/httpx/resolver.rb#230
  def find_supported_ip_families; end

  # source://httpx//lib/httpx/resolver.rb#226
  def id_synchronize(&block); end

  # @return [Boolean]
  #
  # source://httpx//lib/httpx/resolver.rb#248
  def in_ractor?; end

  # source://httpx//lib/httpx/resolver.rb#216
...
# source://httpx//lib/httpx/resolver.rb#11
HTTPX::Resolver::MAX_CACHE_SIZE = T.let(T.unsafe(nil), Integer)
...
class HTTPX::Resolver::Multi
  ...
  # source://httpx//lib/httpx/resolver/multi.rb#30
  def current_selector=(s); end

  # source://httpx//lib/httpx/resolver/multi.rb#35
  def current_session=(s); end

  # source://httpx//lib/httpx/resolver/multi.rb#48
  def early_resolve(connection); end

  # source://httpx//lib/httpx/resolver/multi.rb#74
...
class HTTPX::Resolver::Native < ::HTTPX::Resolver::Resolver
  ...
  # source://httpx//lib/httpx/resolver/native.rb#488
  def build_socket; end

  # source://httpx//lib/httpx/resolver/native.rb#138
  def calculate_interests; end

  # source://httpx//lib/httpx/resolver/native.rb#566
  def close_or_resolve; end

  # source://httpx//lib/httpx/resolver/native.rb#146
  def consume; end

  # source://httpx//lib/httpx/resolver/native.rb#193
  def do_retry(h, connection, interval); end

  # source://httpx//lib/httpx/resolver/native.rb#503
  def downgrade_socket; end

  # source://httpx//lib/httpx/resolver/native.rb#232
  ...
  # source://httpx//lib/httpx/resolver/native.rb#474
  def generate_candidates(name); end

  # source://httpx//lib/httpx/resolver/native.rb#301
  def parse(buffer); end

  # source://httpx//lib/httpx/resolver/native.rb#367
  def parse_addresses(addresses); end

  # source://httpx//lib/httpx/resolver/native.rb#554
  def reset_hostname(hostname, connection: T.unsafe(nil), reset_candidates: T.unsafe(nil)); end

  # source://httpx//lib/httpx/resolver/native.rb#548
  def reset_query; end

  # @raise [Error]
  #
  # source://httpx//lib/httpx/resolver/native.rb#429
  def resolve(connection = T.unsafe(nil), hostname = T.unsafe(nil)); end

  # source://httpx//lib/httpx/resolver/native.rb#174
  def schedule_retry; end

  # source://httpx//lib/httpx/resolver/native.rb#511
  def transition(nextstate); end
end
...
class HTTPX::Response::Body
  ...
  # source://httpx//lib/httpx/response/body.rb#155
  def ==(other); end

  # source://httpx//lib/httpx/response/body.rb#85
  def bytesize; end

  # source://httpx//lib/httpx/response/body.rb#146
  def close; end
  ...
  # source://httpx//lib/httpx/response/body.rb#165
  def inspect; end

  # source://httpx//lib/httpx/response/body.rb#72
  def read(*args); end

  # source://httpx//lib/httpx/response/body.rb#173
  def rewind; end
  ...
  # source://httpx//lib/httpx/response/body.rb#207
  def decode_chunk(chunk); end

  # source://httpx//lib/httpx/response/body.rb#43
  def initialize_dup(other); end

  # source://httpx//lib/httpx/response/body.rb#185
...
class HTTPX::Selector
  ...
  # source://httpx//lib/httpx/selector.rb#270
  def next_timeout; end

  # source://httpx//lib/httpx/selector.rb#293
  ...
  # @yield [io]
  #
  # source://httpx//lib/httpx/selector.rb#241

...
module CssParser
  class << self
    ...
    # ++
    #
    # source://css_parser//lib/css_parser.rb#111
    ...
    #
    # source://css_parser//lib/css_parser.rb#135
...
class CssParser::Parser
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#85
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#525
  def load_file!(file_name, options = T.unsafe(nil), deprecated = T.unsafe(nil)); end

  # Load a local CSS string.
  #
  # source://css_parser//lib/css_parser/parser.rb#550
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#495
  ...
  #
  # source://css_parser//lib/css_parser/parser.rb#571
  ...
  # Returns a string.
  #
  # source://css_parser//lib/css_parser/parser.rb#597
  ...
  # Returns a string.
  #
  # source://css_parser//lib/css_parser/parser.rb#586
  ...
  # ++
  #
  # source://css_parser//lib/css_parser/parser.rb#618
  ...
  # passed hash
  #
  # source://css_parser//lib/css_parser/parser.rb#716
  def css_node_to_h(hash, key, val); end

  # Retrieve a folded declaration block from the internal cache.
  #
  # source://css_parser//lib/css_parser/parser.rb#703
  def get_folded_declaration(block_hash); end

  # source://css_parser//lib/css_parser/parser.rb#707
  def reset!; end

  # Save a folded declaration block to the internal cache.
  #
  # source://css_parser//lib/css_parser/parser.rb#698
...
class CssParser::RuleSet
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#257
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#299
  def [](property); end

  # @see CssParser::RuleSet::Declarations#add_declaration!
  #
  # source://css_parser//lib/css_parser/rule_set.rb#254
  def []=(*_arg0, **_arg1, &_arg2); end

  # @see CssParser::RuleSet::Declarations#add_declaration!
  #
  # source://css_parser//lib/css_parser/rule_set.rb#253
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#544
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#583
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#607
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#510
  def create_shorthand!; end

  # Combine several properties into a shorthand one
  #
  # source://css_parser//lib/css_parser/rule_set.rb#520
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#320
  ...
  #   end
  #
  # source://css_parser//lib/css_parser/rule_set.rb#310
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#350
  def expand_background_shorthand!; end

  # Split shorthand border declarations (e.g. <tt>border: 1px red;</tt>)
  # Additional splitting happens in expand_dimensions_shorthand!
  #
  # source://css_parser//lib/css_parser/rule_set.rb#380
  def expand_border_shorthand!; end

  # Split shorthand dimensional declarations (e.g. <tt>margin: 0px auto;</tt>)
  # into their constituent parts.  Handles margin, padding, border-color, border-style and border-width.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#398
  def expand_dimensions_shorthand!; end

  # Convert shorthand font declarations (e.g. <tt>font: 300 italic 11px/14px verdana, helvetica, sans-serif;</tt>)
  # into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#435
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#490
  def expand_list_style_shorthand!; end

  # Split shorthand declarations (e.g. +margin+ or +font+) into their constituent parts.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#337
  def expand_shorthand!; end

  # source://css_parser//lib/css_parser/rule_set.rb#372
  ...
  # Get the value of a property
  #
  # source://css_parser//lib/css_parser/rule_set.rb#294
  ...
  # @see CssParser::RuleSet::Declarations#delete
  #
  # source://css_parser//lib/css_parser/rule_set.rb#255
  def remove_declaration!(*_arg0, **_arg1, &_arg2); end

  # Array of selector strings.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#244
  def selectors; end

  # Integer with the specificity to use for this RuleSet.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#247
  def specificity; end
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#642
  ...
  # ++
  #
  # source://css_parser//lib/css_parser/rule_set.rb#690
  def parse_selectors!(selectors); end

  # source://css_parser//lib/css_parser/rule_set.rb#698
  def split_value_preserving_function_whitespace(value); end

  # @return [Boolean]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#683
...
# source://css_parser//lib/css_parser/rule_set.rb#16
...
# source://css_parser//lib/css_parser/rule_set.rb#21
...
class CssParser::RuleSet::Declarations
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#71
  def initialize(declarations = T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#214
  def ==(other); end
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#95
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#130
  ...
  # @return [Boolean]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#117
  ...
  # @param property [#to_s] property to be removed
  #
  # source://css_parser//lib/css_parser/rule_set.rb#133
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#148
  def replace_declaration!(property, replacements, preserve_importance: T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#121
  def size; end
  ...
  # @param value the value to set the attribute declarations to.
  #
  # source://css_parser//lib/css_parser/rule_set.rb#226
  def declarations=(_arg0); end

  # source://css_parser//lib/css_parser/rule_set.rb#228
...
class CssParser::RuleSet::Declarations::Value
  ...
  #
  # source://css_parser//lib/css_parser/rule_set.rb#42
  def initialize(value, important: T.unsafe(nil)); end

  # source://css_parser//lib/css_parser/rule_set.rb#60
  def ==(other); end
  ...
  # source://css_parser//lib/css_parser/rule_set.rb#56
  def to_s; end
  ...
  # @raise [ArgumentError]
  #
  # source://css_parser//lib/css_parser/rule_set.rb#47
  def value=(value); end
end

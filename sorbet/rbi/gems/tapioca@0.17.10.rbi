...
# ~~~
#
# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#152
class Tapioca::Dsl::Compilers::ActiveRecordRelations < ::Tapioca::Dsl::Compiler
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#251
  sig { returns(::RBI::Scope) }
  def association_relation_methods_module; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#267
  sig { params(method_name: ::Symbol).returns(T::Boolean) }
  def bang_method?(method_name); end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#977
  sig do
    params(
      method_name: ::Symbol
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#257
  sig { returns(::RBI::Scope) }
  def common_relation_methods_module; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#262
  sig { returns(::String) }
  def constant_name; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#306
  sig { void }
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#609
  sig { void }
  def create_association_relation_methods; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#416
  sig { void }
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#449
  sig { void }
  def create_collection_proxy_class; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#466
  sig { params(klass: ::RBI::Scope).void }
  def create_collection_proxy_methods(klass); end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#1002
  sig do
    params(
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#616
  sig { void }
  def create_common_methods; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#344
  sig { params(klass: ::RBI::Scope).void }
  def create_group_chain_methods(klass); end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#287
  sig { void }
  def create_relation_class; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#325
  sig { void }
  ...
  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#545
  sig { void }
  def create_relation_methods; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#408
  sig { void }
  def create_relation_where_chain_class; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#424
  sig { params(klass: ::RBI::Scope, return_type: ::String).void }
  def create_where_chain_methods(klass, return_type); end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#1011
  sig { void }
  def create_where_relation_method; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#241
  sig { returns(::RBI::Scope) }
  def model; end

  # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#246
  sig { returns(::RBI::Scope) }
  def relation_methods_module; end

  class << self
    # source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#191
    sig { override.returns(T::Enumerable[T::Module[T.anything]]) }
    def gather_constants; end
  end
end

# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#196
...
# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#198
...
#
# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#162
Tapioca::Dsl::Compilers::ActiveRecordRelations::ID_TYPES = T.let(T.unsafe(nil), Set)

# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#201
...
# source://tapioca//lib/tapioca/dsl/compilers/active_record_relations.rb#215
...
module Tapioca::Dsl::Helpers::ActiveModelTypeHelper
  class << self
    ...
    # source://tapioca//lib/tapioca/dsl/helpers/active_model_type_helper.rb#59
    ...
    # source://tapioca//lib/tapioca/dsl/helpers/active_model_type_helper.rb#69
    sig { params(obj: T.untyped, method: ::Symbol).returns(T.untyped) }
    def lookup_signature_of_method(obj, method); end

    # source://tapioca//lib/tapioca/dsl/helpers/active_model_type_helper.rb#46
    sig { params(obj: T.untyped).returns(T.nilable(::T::Types::Base)) }
    def lookup_tapioca_type(obj); end

    # source://tapioca//lib/tapioca/dsl/helpers/active_model_type_helper.rb#41
...
class Tapioca::Dsl::Helpers::ActiveRecordColumnTypeHelper
  ...
  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#59
  sig do
    params(
  ...
  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#65
  ...
  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#220
  ...
  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#94
  sig { params(column_name: T.nilable(::String)).returns([::String, ::String]) }
  def column_type_for(column_name); end

  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#230
  sig { params(column_type: ::ActiveRecord::Enum::EnumType).returns(::String) }
  def enum_setter_type(column_type); end

  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#74
  sig { returns([::String, ::String]) }
  def id_type; end

  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#258
  sig { params(column_type: T.untyped).returns(T::Boolean) }
  def not_nilable_serialized_column?(column_type); end

  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#241
  sig { params(column_type: ::ActiveRecord::Type::Serialized).returns(::String) }
  def serialized_column_type(column_type); end

  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#117
...
class Tapioca::Dsl::Helpers::ActiveRecordColumnTypeHelper::ColumnTypeOption < ::T::Enum
  ...
  # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#43
  sig { returns(T::Boolean) }
  def persisted?; end
  ...
  class << self
    # source://tapioca//lib/tapioca/dsl/helpers/active_record_column_type_helper.rb#26
    sig do
      params(
        options: T::Hash[::String, T.untyped],
...
# source://tapioca//lib/tapioca/dsl/helpers/active_record_constants_helper.rb#23
Tapioca::Dsl::Helpers::ActiveRecordConstantsHelper::AssociationRelationMethodsModuleName = T.let(T.unsafe(nil), String)

# source://tapioca//lib/tapioca/dsl/helpers/active_record_constants_helper.rb#31
Tapioca::Dsl::Helpers::ActiveRecordConstantsHelper::AssociationRelationWhereChainClassName = T.let(T.unsafe(nil), String)

# source://tapioca//lib/tapioca/dsl/helpers/active_record_constants_helper.rb#32
...
# source://tapioca//lib/tapioca/dsl/helpers/active_record_constants_helper.rb#19

...
#   end
#
# source://phonelib//lib/validators/phone_validator.rb#56
class PhoneValidator < ::ActiveModel::EachValidator
  include ::Phonelib::Core

  # Validation method
  #
  # source://phonelib//lib/validators/phone_validator.rb#61
  ...
  # @private
  #
  # source://phonelib//lib/validators/phone_validator.rb#128
  def countries; end

  # source://phonelib//lib/validators/phone_validator.rb#72
  def message; end

  # @private
  #
  # source://phonelib//lib/validators/phone_validator.rb#116
  def phone_countries; end

  # @private
  #
  # source://phonelib//lib/validators/phone_validator.rb#106
  def phone_types; end

  # @return [Boolean]
  #
  # source://phonelib//lib/validators/phone_validator.rb#76
  def phone_valid?; end

  # source://phonelib//lib/validators/phone_validator.rb#95
  def specified_country(record); end

  # @private
  #
  # source://phonelib//lib/validators/phone_validator.rb#122
  def types; end

  # @return [Boolean]
  #
  # source://phonelib//lib/validators/phone_validator.rb#85
  def valid_country?; end

  # @return [Boolean]
  #
  # source://phonelib//lib/validators/phone_validator.rb#90
  def valid_extensions?; end

  # @return [Boolean]
  #
  # source://phonelib//lib/validators/phone_validator.rb#80
  def valid_types?; end
end

# main Phonelib module definition
#
# source://phonelib//lib/phonelib.rb#4
module Phonelib
...
#
# source://phonelib//lib/phonelib/core.rb#5
module Phonelib::Core
  # source://phonelib//lib/phonelib/core.rb#204
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#59
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#11
  def eager_load!; end
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#91
  ...
  # @return [String] Default extension separator symbols used for parsing
  #
  # source://phonelib//lib/phonelib/core.rb#98
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#75
  ...
  # @return [String] Default extension separator used for formatting
  #
  # source://phonelib//lib/phonelib/core.rb#82
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#140
  def ignore_plus; end
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#437
  ...
  # setter for data file to use
  #
  # source://phonelib//lib/phonelib/core.rb#185
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#423
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#108
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#24
  def phone_data; end
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#42
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#156
  ...
  # source://phonelib//lib/phonelib/core.rb#18
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#124
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#430
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#459
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#231
  ...
  #
  # source://phonelib//lib/phonelib/core.rb#474
  def load_data; end

  # @private Load extended data file into memory
  #
  # source://phonelib//lib/phonelib/core.rb#500
...
#
# source://phonelib//lib/phonelib/core.rb#347
...
#
# source://phonelib//lib/phonelib/core.rb#341
...
#
# source://phonelib//lib/phonelib/core.rb#405
...
#
# source://phonelib//lib/phonelib/core.rb#401
...
#
# source://phonelib//lib/phonelib/core.rb#412
...
# source://phonelib//lib/phonelib/core.rb#416
...
# @private Plus sign
#
# source://phonelib//lib/phonelib/core.rb#335
...
# source://phonelib//lib/phonelib/core.rb#415
...
#
# source://phonelib//lib/phonelib/phone.rb#5
class Phonelib::Phone
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#27
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#48
  def ==(other); end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#95
  def countries; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#115
  def country; end

  # @return [String] phone extension passed for parsing after a number
  #
  # source://phonelib//lib/phonelib/phone.rb#11
  def extension; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#89
  def human_type; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#83
  def human_types; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#139
  def impossible?; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#127
  def invalid?; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#175
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#133
  def possible?; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#71
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#56
  def sanitized; end

  # method returns string representation of parsed phone
  #
  # source://phonelib//lib/phonelib/phone.rb#41
  def to_s; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#77
  def type; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#65
  def types; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#121
  def valid?; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#101
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#109
  def valid_country; end
  ...
  #
  # source://phonelib//lib/phonelib/phone.rb#162
...
module Phonelib::PhoneAnalyzer
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#20
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#164
  def convert_to_e164(phone, data); end

  # source://phonelib//lib/phonelib/phone_analyzer.rb#153
  ...
  # * +phone+ - phone number for parsing
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#134
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#243
  ...
  # * +not_valid+ - specifies that number is not valid by general desc pattern
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#185
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#229
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer.rb#97
...
module Phonelib::PhoneAnalyzerHelper
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#61
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#106
  def country_or_default_country(country); end

  # returns country prefix for provided country or nil
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#49
  ...
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#8
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#89
  ...
  # * +data+  - country data
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#190
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#123
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#221
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#206
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#97
  def original_s; end
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#38
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#155
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#164
  ...
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#141
  ...
  # * +data+  - country data hash
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#178
  def types_for_check(data); end

  # converts symbols in phone to numbers
  #
  # source://phonelib//lib/phonelib/phone_analyzer_helper.rb#24
...
module Phonelib::PhoneExtendedData
  ...
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#39
  def carrier; end
  ...
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#16
  def geo_name; end
  ...
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#24
  def timezone; end
  ...
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#31
  def timezones; end

  # returns valid country name
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#45
  ...
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#87
  def default_ext_data; end

  # @private returns extended data ids for current number
  #
  # source://phonelib//lib/phonelib/phone_extended_data.rb#67
  def ext_data; end
...
module Phonelib::PhoneFormatter
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#36
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#93
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#86
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#79
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#72
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#54
  def international(formatted = T.unsafe(nil), prefix = T.unsafe(nil)); end

  # source://phonelib//lib/phonelib/phone_formatter.rb#112
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#9
  ...
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#23
  ...
  # @return [Boolean]
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#128
  def area_code_possible?; end

  # source://phonelib//lib/phonelib/phone_formatter.rb#123
  def data_country_code; end

  # @private returns extension with separator defined
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#141
  def formatted_extension; end

  # @private Get needable data for formatting phone as national number
  #
  # source://phonelib//lib/phonelib/phone_formatter.rb#148
  def formatting_data; end
end

# source://phonelib//lib/phonelib.rb#20

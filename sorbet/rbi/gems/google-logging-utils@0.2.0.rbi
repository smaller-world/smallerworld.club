...
#
# pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:18
module Google; end

# Classes and utilities related to logging to and from Google products
#
# pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:19
...
# agent.
#
# pkg:gem/google-logging-utils#lib/google/logging/message.rb:36
class Google::Logging::Message
  ...
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:98
  ...
  # @private
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:200
  def ==(other); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:212
  def eql?(other); end

  # @return [Hash{String=>Object},nil] The log message as a set of
  #     key-value pairs, or nil if not present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:137
  def fields; end

  # @return [String] A full string representation of the message and fields
  #     as rendered in the standard logger formatter.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:130
  def full_message; end

  # @private
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:215
  def hash; end
  ...
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:155
  def insert_id; end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:131
  def inspect; end

  # @return [Hash{String=>String},nil] Metadata, or nil if not present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:179
  def labels; end
  ...
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:123
  def message; end

  # @return [SourceLocation,nil] The source location for the log entry, or
  #     nil if not present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:149
  def source_location; end

  # @return [String,nil] The trace span containing this entry, or nil if
  #     not present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:167
  def span_id; end

  # @return [Time,nil] The timestamp for the log entry, or nil if not
  #     present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:143
  def timestamp; end

  # @return [Hash] A hash of kwargs that can be passed to the constructor
  #     to clone this message.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:185
  def to_h; end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:124
  def to_s; end

  # @return [String,nil] The Google Cloud Trace resource name, or nil if
  #     not present.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:161
  def trace; end

  # @return [true,false,nil] Whether this trace is sampled, or nil if not
  #     present or known.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:173
  def trace_sampled; end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:174
  def trace_sampled?; end

  private

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:298
  def interpret_boolean(input); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:231
  def interpret_fields(fields); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:303
  def interpret_labels(input); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:261
  def interpret_message(message, fields); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:283
  def interpret_source_location(source_location); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:294
  def interpret_string(input); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:272
  def interpret_timestamp(timestamp); end

  # pkg:gem/google-logging-utils#lib/google/logging/message.rb:242
  ...
  class << self
    ...
    # @return [Message]
    #
    # pkg:gem/google-logging-utils#lib/google/logging/message.rb:50
    def from(input); end
  end
end
...
# @private
#
# pkg:gem/google-logging-utils#lib/google/logging/message.rb:222
...
#
# pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:23
class Google::Logging::SourceLocation
  ...
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:59
  def initialize(file:, line:, function:); end

  # @private
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:84
  def ==(other); end

  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:88
  def eql?(other); end

  # @return [String] Path to the source file.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:66
  def file; end

  # @return [String] Name of the calling function.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:72
  def function; end

  # @private
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:91
  def hash; end

  # @return [String] Line number as a string.
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:69
  def line; end

  # @private
  #
  # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:75
  def to_h; end
  ...
  class << self
    ...
    #
    # pkg:gem/google-logging-utils#lib/google/logging/source_location.rb:37

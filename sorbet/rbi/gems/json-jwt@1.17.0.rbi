...
class JSON::JWE
  ...
  # source://json-jwt//lib/json/jwe.rb#13
  def alg; end
  ...
  # source://json-jwt//lib/json/jwe.rb#22
  def apu; end
  ...
  # source://json-jwt//lib/json/jwe.rb#23
...
module JSON::JWK::Set::Fetcher
  class << self
    # source://json-jwt//lib/json/jwk/set/fetcher.rb#58
    def cache; end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#55
    def cache=(cache); end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#33
    def debug(&block); end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#30
    def debug!; end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#27
    def debugging=(boolean); end

    # @return [Boolean]
    #
    # source://json-jwt//lib/json/jwk/set/fetcher.rb#24
    def debugging?; end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#63
    def fetch(jwks_uri, kid:, auto_detect: T.unsafe(nil), **options); end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#42
    def http_client; end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#51
    def http_config(&block); end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#15
    def logger; end

    # source://json-jwt//lib/json/jwk/set/fetcher.rb#18
    def logger=(logger); end
  end
end

# source://json-jwt//lib/json/jwk/set/fetcher.rb#7
class JSON::JWK::Set::Fetcher::Cache
  # source://json-jwt//lib/json/jwk/set/fetcher.rb#12
  def delete(cache_key, options = T.unsafe(nil)); end

  # source://json-jwt//lib/json/jwk/set/fetcher.rb#8
...
class JSON::JWT < ::ActiveSupport::HashWithIndifferentAccess
  ...
  # source://json-jwt//lib/json/jwt.rb#23
  def alg; end

...
#   end
#
# pkg:gem/net-ssh#lib/net/ssh/errors.rb:2
module Net::SSH
  class << self
...
# pkg:gem/net-ssh#lib/net/ssh/proxy/errors.rb:5
...
#   end
#
# pkg:gem/net-ssh#lib/net/ssh/proxy/command.rb:18

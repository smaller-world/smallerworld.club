...
class RQRCodeCore::QRCode
  ...
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#105
  ...
  # @return [Boolean]
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#150
  ...
  # @return [Boolean]
  #
  # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_code.rb#156
...
class RQRCodeCore::QRUtil
  class << self
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#165
    ...
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#232
    def demerit_points_3_dangerous_patterns(modules); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#264
    ...
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#83
    def get_bch_format_info(data); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#96
    def get_bch_version(data); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#125
    def get_error_correct_polynomial(error_correct_length); end

    # @raise [QRCodeRunTimeError]
    #
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#135
    def get_length_in_bits(mode, version); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#154
    def get_lost_points(modules); end

    # @raise [QRCodeRunTimeError]
    #
    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#119
    def get_mask(mask_pattern, i, j); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#115
    def get_pattern_positions(version); end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#79
    def max_size; end

    # source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#91
...
#
# source://rqrcode_core//lib/rqrcode_core/qrcode/qr_util.rb#77
RQRCodeCore::QRUtil::ARCH_BITS = T.let(T.unsafe(nil), Integer)

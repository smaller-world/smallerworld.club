...
module RubyNext
  class << self
    # source://ruby-next-core//lib/ruby-next/config.rb#36
    ...
    # @return [Boolean]
    #
    # source://ruby-next-core//lib/ruby-next/config.rb#42
    def edge_syntax?; end

    # Load transpile settings from the RC file (nextify command flags)
    #
    # source://ruby-next-core//lib/ruby-next/config.rb#68
    def load_from_rc(path = T.unsafe(nil)); end

    # source://ruby-next-core//lib/ruby-next/config.rb#50
    def next_ruby_version(version = T.unsafe(nil)); end

    # @return [Boolean]
    #
    # source://ruby-next-core//lib/ruby-next/config.rb#46
...
class RubyNext::Core::Patch
  ...
  # Returns the value of attribute native.
  #
  # source://ruby-next-core//lib/ruby-next/core.rb#48
  def native?; end
  ...
  # Returns the value of attribute singleton.
  #
  # source://ruby-next-core//lib/ruby-next/core.rb#49
  def singleton?; end
  ...
  # Returns the value of attribute supported.
  #
  # source://ruby-next-core//lib/ruby-next/core.rb#47
  def supported?; end
...
# source://ruby-next-core//lib/ruby-next/core/string/strip.rb#88
module RubyNext::Core::StringStripSelectors
  class << self
    ...
    #
    # source://ruby-next-core//lib/ruby-next/core/string/strip.rb#91
    def build_pattern(selectors); end

    # source://ruby-next-core//lib/ruby-next/core/string/strip.rb#128
    def escape_for_char_class(selector); end
  end
end
...
# source://ruby-next-core//lib/ruby-next/config.rb#17
...
#
# source://ruby-next-core//lib/ruby-next/config.rb#20

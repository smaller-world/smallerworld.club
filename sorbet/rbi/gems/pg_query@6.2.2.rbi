...
module PgQuery
  class << self
    # source://pg_query//lib/pg_query.rb#7
    ...
    #
    # source://pg_query//lib/pg_query/deparse.rb#16
    ...
    #
    # source://pg_query//lib/pg_query/deparse.rb#46
    ...
    #
    # source://pg_query//lib/pg_query/deparse.rb#41
    ...
    # source://pg_query//lib/pg_query/scan.rb#11
    def scan(query); end

    # @raise [SplitError]
    #
    # source://pg_query//lib/pg_query/split.rb#11
...
class PgQuery::DeparseComment
  ...
  # Sets the attribute match_location
  #
  # @param value the value to set the attribute match_location to.
  #
  # source://pg_query//lib/pg_query/deparse.rb#9
  ...
  # Sets the attribute newlines_after_comment
  #
  # @param value the value to set the attribute newlines_after_comment to.
  #
  # source://pg_query//lib/pg_query/deparse.rb#9
  ...
  # Sets the attribute newlines_before_comment
  #
  # @param value the value to set the attribute newlines_before_comment to.
  #
  # source://pg_query//lib/pg_query/deparse.rb#9
...
# source://pg_query//lib/pg_query/deparse.rb#12
class PgQuery::DeparseOpts < ::Struct
  # Returns the value of attribute commas_start_of_line
  #
  # @return [Object] the current value of commas_start_of_line
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  def commas_start_of_line; end

  # Sets the attribute commas_start_of_line
  #
  # @param value [Object] the value to set the attribute commas_start_of_line to.
  ...
  #
  # @return [Object] the current value of indent_size
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  def indent_size; end

  # Sets the attribute indent_size
  #
  # @param value [Object] the value to set the attribute indent_size to.
  # @return [Object] the newly set value
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  ...
  #
  # @return [Object] the current value of max_line_length
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  ...
  #
  # @param value [Object] the value to set the attribute max_line_length to.
  # @return [Object] the newly set value
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  ...
  #
  # @return [Object] the current value of pretty_print
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  ...
  #
  # @param value [Object] the value to set the attribute pretty_print to.
  # @return [Object] the newly set value
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  ...
  #
  # @return [Object] the current value of trailing_newline
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
  def trailing_newline; end

  # Sets the attribute trailing_newline
  #
  # @param value [Object] the value to set the attribute trailing_newline to.
  # @return [Object] the newly set value
  #
  # source://pg_query//lib/pg_query/deparse.rb#12
...
module PgQuery::KeywordKind
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#360
    def descriptor; end
...
module PgQuery::LimitOption
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#356
    def descriptor; end
...
module PgQuery::LockClauseStrength
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#357
    def descriptor; end
...
module PgQuery::LockTupleMode
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#359
    def descriptor; end
...
module PgQuery::LockWaitPolicy
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#358
    def descriptor; end
...
module PgQuery::OnConflictAction
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#355
    def descriptor; end
...
class PgQuery::ParseError < ::ArgumentError
  ...
  #
  # source://pg_query//lib/pg_query/parse_error.rb#5
...
class PgQuery::ParserResult
  ...
  # source://pg_query//lib/pg_query/parse.rb#79
  def aliases; end

  # source://pg_query//lib/pg_query/parse.rb#70
  def call_functions; end

  # source://pg_query//lib/pg_query/parse.rb#74
  def cte_names; end

  # source://pg_query//lib/pg_query/parse.rb#66
  def ddl_functions; end

  # source://pg_query//lib/pg_query/parse.rb#55
  def ddl_tables; end
  ...
  #
  # source://pg_query//lib/pg_query/treewalker.rb#22
  ...
  # types.
  #
  # source://pg_query//lib/pg_query/parse.rb#62
  def functions; end

  # source://pg_query//lib/pg_query/parse.rb#89
  ...
  # source://pg_query//lib/pg_query/parse.rb#84
  ...
  #
  # source://pg_query//lib/pg_query/truncate.rb#7
  ...
  #
  # source://pg_query//lib/pg_query/treewalker.rb#12
  def walk!(&block); end
  ...
  #
  # source://pg_query//lib/pg_query/parse.rb#100
  def load_objects!; end

  # source://pg_query//lib/pg_query/parse.rb#359
  def statements_and_cte_names_for_with_clause(with_clause); end

  private

  # source://pg_query//lib/pg_query/truncate.rb#123
  def cols_len(cols); end

  # source://pg_query//lib/pg_query/truncate.rb#59
  def find_possible_truncations; end

  # source://pg_query//lib/pg_query/fingerprint.rb#132
  ...
  # source://pg_query//lib/pg_query/fingerprint.rb#153
  ...
  # source://pg_query//lib/pg_query/truncate.rb#95
  def select_target_list_len(target_list); end

  # source://pg_query//lib/pg_query/truncate.rb#104
  def select_values_lists_len(values_lists); end

  # source://pg_query//lib/pg_query/treewalker.rb#31
  def treewalker!(tree); end

  # source://pg_query//lib/pg_query/treewalker.rb#57
  def treewalker_with_location!(tree); end

  # source://pg_query//lib/pg_query/truncate.rb#113
...
# source://pg_query//lib/pg_query/truncate.rb#3
class PgQuery::ParserResult::PossibleTruncation < ::Struct
  ...
  #
  # @return [Object] the current value of len
  #
  # source://pg_query//lib/pg_query/truncate.rb#3
  def len; end

  # Sets the attribute len
  #
  # @param value [Object] the value to set the attribute len to.
  # @return [Object] the newly set value
  #
  # source://pg_query//lib/pg_query/truncate.rb#3
  def len=(_); end
...
class PgQuery::ScanError < ::ArgumentError
  ...
  #
  # source://pg_query//lib/pg_query/scan.rb#5
  def initialize(message, source_file, source_line, location); end
...
# source://pg_query//lib/pg_query/split.rb#2
class PgQuery::SplitError < ::ArgumentError
  # @return [SplitError] a new instance of SplitError
  #
  # source://pg_query//lib/pg_query/split.rb#5
  def initialize(message, source_file, source_line, location); end

  # Returns the value of attribute location.
  #
  # source://pg_query//lib/pg_query/split.rb#3
  def location; end
end
...
module PgQuery::SummaryResult::Context
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#290
    def descriptor; end
...
module PgQuery::Token
  class << self
    # source://pg_query//lib/pg_query/pg_query_pb.rb#361
    def descriptor; end

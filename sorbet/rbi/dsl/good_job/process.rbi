...
class GoodJob::Process
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::GoodJob::Process]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::GoodJob::Process]])
    end
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_lock_type?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_lock_type?(from: T.unsafe(nil), to: T.unsafe(nil)); end

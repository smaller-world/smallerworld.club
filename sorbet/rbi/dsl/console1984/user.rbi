...
# This is an autogenerated file for dynamic methods in `Console1984::User`.
# Please instead update this file by running `bin/tapioca dsl Console1984::User`.
...
class Console1984::User
  ...
  class << self
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::Console1984::User).void)
      ).returns(::Console1984::User)
    end
    def new(attributes = nil, &block); end
  end

  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Console1984::User).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::Console1984::User).void)).returns(::Console1984::User) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::Console1984::User).void)
      ).returns(T::Array[::Console1984::User])
    end
    sig do
      params(
        attributes: T.untyped,
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::Console1984::User).void).returns(Integer) }
    ...
    sig do
      params(
        records: T.any(::Console1984::User, Integer, String, T::Enumerable[T.any(::Console1984::User, Integer, String, T::Enumerable[::Console1984::User])])
      ).returns(Integer)
    end
    ...
    sig { returns(T::Array[::Console1984::User]) }
    def destroy_all; end

    sig { returns(T::Array[::Console1984::User]) }
    def destroy_all; end

    sig { params(args: T.untyped).returns(T::Array[::Console1984::User]) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Console1984::User])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::Console1984::User).void
      ).returns(T.nilable(::Console1984::User))
    end
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Console1984::User)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Console1984::User) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[::Console1984::User])
    end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol]),
        block: T.proc.params(object: T::Array[::Console1984::User]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Console1984::User]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Console1984::User)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Console1984::User) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::Console1984::User) }
    def find_sole_by(arg, *args); end

    sig { returns(T.nilable(::Console1984::User)) }
    sig { params(limit: Integer).returns(T::Array[::Console1984::User]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Console1984::User).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Console1984::User` class because it declared `has_many :sessions`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
    sig { returns(::Console1984::Session::PrivateCollectionProxy) }
    def sessions; end

    sig { params(value: T::Enumerable[::Console1984::Session]).void }
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig do
      params(
        blk: T.proc.params(record: ::Console1984::User).returns(BasicObject)
      ).returns(T::Array[::Console1984::User])
    end
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::Console1984::User } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Console1984::User, T::Enumerable[T.any(::Console1984::User, T::Enumerable[::Console1984::User])])
    ...
    sig do
      params(
        other_array: T.any(::Console1984::User, T::Enumerable[T.any(::Console1984::User, T::Enumerable[::Console1984::User])])
      ).returns(T::Array[::Console1984::User])
    end

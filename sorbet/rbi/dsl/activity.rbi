...
class Activity
  ...
  module CommonRelationMethods
    ...
    sig { params(args: NilClass, block: T.proc.params(object: ::Activity).void).returns(T.nilable(::Activity)) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: ::Activity).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Activity]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Activity]])
    end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Activity).returns(T.type_parameter(:U))

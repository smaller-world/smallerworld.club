...
# This is an autogenerated file for dynamic methods in `Space`.
# Please instead update this file by running `bin/tapioca dsl Space`.
...
class Space
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::Space).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end
    ...
    sig do
      params(
        records: T.any(::Space, Integer, String, T::Enumerable[T.any(::Space, Integer, String, T::Enumerable[::Space])])
      ).returns(Integer)
    end
    ...
    sig { params(args: T.untyped).returns(T::Array[::Space]) }
    ...
    sig do
      ...
      ).returns(T::Enumerable[::Space])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::Space).void).returns(T.nilable(::Space)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::Space)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::Space) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: ::Space).void
      ).void
    end
    sig do
      params(
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::Space]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::Space]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::Space)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::Space) }
    def find_signed!(signed_id, purpose: nil); end
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::Space).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Space).returns(BasicObject)).returns(T::Array[::Space]) }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::Space, T::Enumerable[T.any(::Space, T::Enumerable[::Space])])
    ...
    sig do
      params(
        other_array: T.any(::Space, T::Enumerable[T.any(::Space, T::Enumerable[::Space])])
      ).returns(T::Array[::Space])
    end

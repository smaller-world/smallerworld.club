...
# This is an autogenerated file for dynamic methods in `PostReaction`.
# Please instead update this file by running `bin/tapioca dsl PostReaction`.
...
class PostReaction
  ...
  class << self
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::PostReaction).void)
      ).returns(::PostReaction)
    end
    def new(attributes = nil, &block); end
  end

  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::PostReaction).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::PostReaction).void)).returns(::PostReaction) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::PostReaction).void)
      ).returns(T::Array[::PostReaction])
    end
    sig do
      params(
        attributes: T.untyped,
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::PostReaction).void).returns(Integer) }
    ...
    sig do
      params(
        records: T.any(::PostReaction, Integer, String, T::Enumerable[T.any(::PostReaction, Integer, String, T::Enumerable[::PostReaction])])
      ).returns(Integer)
    end
    ...
    sig { returns(T::Array[::PostReaction]) }
    def destroy_all; end

    sig { returns(T::Array[::PostReaction]) }
    def destroy_all; end

    sig { params(args: T.untyped).returns(T::Array[::PostReaction]) }
    def destroy_by(args); end

    sig { params(conditions: T.untyped).returns(T::Boolean) }
    def exists?(conditions = :none); end

    sig { returns(T.nilable(::PostReaction)) }
    def fifth; end
    ...
    sig do
      ...
      ).returns(T::Enumerable[::PostReaction])
    end
    sig do
      params(
        args: NilClass,
        block: T.proc.params(object: ::PostReaction).void
      ).returns(T.nilable(::PostReaction))
    end
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::PostReaction)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::PostReaction) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::PostReaction])
    end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::PostReaction]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::PostReaction]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::PostReaction)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::PostReaction) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::PostReaction) }
    def find_sole_by(arg, *args); end

    sig { returns(T.nilable(::PostReaction)) }
    sig { params(limit: Integer).returns(T::Array[::PostReaction]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::PostReaction).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::PostReaction).returns(BasicObject)).returns(T::Array[::PostReaction]) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::PostReaction } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::PostReaction, T::Enumerable[T.any(::PostReaction, T::Enumerable[::PostReaction])])
    ...
    sig do
      params(
        other_array: T.any(::PostReaction, T::Enumerable[T.any(::PostReaction, T::Enumerable[::PostReaction])])
      ).returns(T::Array[::PostReaction])
    end

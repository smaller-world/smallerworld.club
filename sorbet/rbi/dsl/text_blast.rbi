...
# This is an autogenerated file for dynamic methods in `TextBlast`.
# Please instead update this file by running `bin/tapioca dsl TextBlast`.
...
class TextBlast
  ...
  class << self
    sig do
      params(
        ...
        block: T.nilable(T.proc.params(object: ::TextBlast).void)
      ).returns(::TextBlast)
    end
  ...
  module CommonRelationMethods
    sig { params(block: T.nilable(T.proc.params(record: ::TextBlast).returns(T.untyped))).returns(T::Boolean) }
    def any?(&block); end

    sig { params(column_name: T.any(String, Symbol)).returns(T.any(Integer, Float, BigDecimal)) }
    def average(column_name); end

    sig { params(block: T.nilable(T.proc.params(object: ::TextBlast).void)).returns(::TextBlast) }
    sig do
      params(
    ...
    sig { params(column_name: NilClass, block: T.proc.params(object: ::TextBlast).void).returns(Integer) }
    ...
    sig { returns(T.nilable(::TextBlast)) }
    def fifth; end
    ...
    sig do
      ...
      ).returns(T::Enumerable[::TextBlast])
    end
    sig { params(args: NilClass, block: T.proc.params(object: ::TextBlast).void).returns(T.nilable(::TextBlast)) }
    def find(args = nil, &block); end

    sig { params(args: T.untyped).returns(T.nilable(::TextBlast)) }
    def find_by(*args); end

    sig { params(args: T.untyped).returns(::TextBlast) }
    def find_by!(*args); end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: ::TextBlast).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[::TextBlast])
    end
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol,
        block: T.proc.params(object: T::Array[::TextBlast]).void
      ).void
    end
    sig do
      params(
        ...
        cursor: T.untyped,
        order: Symbol
      ).returns(T::Enumerator[T::Enumerator[::TextBlast]])
    end
    ...
    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(T.nilable(::TextBlast)) }
    def find_signed(signed_id, purpose: nil); end

    sig { params(signed_id: T.untyped, purpose: T.untyped).returns(::TextBlast) }
    def find_signed!(signed_id, purpose: nil); end

    sig { params(arg: T.untyped, args: T.untyped).returns(::TextBlast) }
    def find_sole_by(arg, *args); end

    sig { returns(T.nilable(::TextBlast)) }
    sig { params(limit: Integer).returns(T::Array[::TextBlast]) }
    ...
    sig do
      type_parameters(:U)
        .params(
          ...
          block: T.proc.params(object: ::TextBlast).returns(T.type_parameter(:U))
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::TextBlast).returns(BasicObject)).returns(T::Array[::TextBlast]) }
  ...
  class PrivateAssociationRelation < ::ActiveRecord::AssociationRelation
    ...
    Elem = type_member { { fixed: ::TextBlast } }
  ...
  class PrivateCollectionProxy < ::ActiveRecord::Associations::CollectionProxy
    ...
    sig do
      params(
        records: T.any(::TextBlast, T::Enumerable[T.any(::TextBlast, T::Enumerable[::TextBlast])])
    ...
    sig do
      params(
        other_array: T.any(::TextBlast, T::Enumerable[T.any(::TextBlast, T::Enumerable[::TextBlast])])
      ).returns(T::Array[::TextBlast])
    end

...
class Image
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::Image).void)).returns(::Image) }
    sig do
      params(
        attributes: T::Array[T.untyped],
        block: T.nilable(T.proc.params(object: ::Image).void)
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Image]])
    end
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Image).returns(BasicObject)).returns(T::Array[::Image]) }

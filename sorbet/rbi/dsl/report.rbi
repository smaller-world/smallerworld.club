...
class Report
  ...
  module CommonRelationMethods
    ...
    sig { params(block: T.nilable(T.proc.params(object: ::Report).void)).returns(::Report) }
    sig do
      params(
    ...
    sig { params(args: T.untyped).returns(T::Array[::Report]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Report]])
    end
  ...
  module GeneratedAssociationRelationMethods
    ...
    sig { params(blk: T.proc.params(record: ::Report).returns(BasicObject)).returns(T::Array[::Report]) }

...
class PushSubscription
  ...
  module GeneratedAttributeMethods
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_service_worker_version?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_service_worker_version?(from: T.unsafe(nil), to: T.unsafe(nil)); end

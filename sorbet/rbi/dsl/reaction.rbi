...
class Reaction
  ...
  module CommonRelationMethods
    ...
    sig { params(args: T.untyped).returns(T::Array[::Reaction]) }
    ...
    sig do
      params(
        ...
        cursor: T.untyped,
        order: T.any(Symbol, T::Array[Symbol])
      ).returns(T::Enumerator[T::Array[::Reaction]])
    end
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Reaction` class because it declared `has_many :notifications`.

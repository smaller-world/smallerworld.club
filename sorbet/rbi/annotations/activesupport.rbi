...
class ActiveSupport::ContinuousIntegration
  sig { params(title: T.untyped, subtitle: T.untyped, block: T.proc.bind(T.attached_class).void).void }
  def self.run(title = T.unsafe(nil), subtitle = T.unsafe(nil), &block); end
end

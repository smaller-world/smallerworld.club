...
declare global {
  ...
  interface BeforeInstallPromptEvent extends Event {
     ...
     * event was dispatched. This is provided for user agents that want to
     * present a choice of versions to the user such as, for example, "web" or
     * "play" which would allow the user to chose between a web version or an
     * Android version.
     */
